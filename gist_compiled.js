...
goog.require('lt.objs.editor.pool');
goog.require('lt.objs.command');
lt.plugins.gist.gist = lt.object.create.call(null,lt.object.object_STAR_.call(null,new cljs.core.Keyword("lt.plugins.gist","gist","lt.plugins.gist/gist",4275746759),new cljs.core.Keyword(null,"name","name",1017277949),"Gist data",new cljs.core.Keyword(null,"behaviors","behaviors",607554515),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("lt.plugins.gist","submit-gist","lt.plugins.gist/submit-gist",4275136818),new cljs.core.Keyword("lt.plugins.gist","on-out","lt.plugins.gist/on-out",3422353434)], null)));
